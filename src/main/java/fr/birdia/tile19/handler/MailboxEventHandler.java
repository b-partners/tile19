package fr.birdia.tile19.handler;

import static fr.birdia.tile19.concurrency.ThreadRenamer.renameWorkerThread;
...
import fr.birdia.tile19.PojaApplication;
import fr.birdia.tile19.PojaGenerated;
import fr.birdia.tile19.endpoint.EndpointConf;
import fr.birdia.tile19.endpoint.event.EventConf;
import fr.birdia.tile19.endpoint.event.consumer.EventConsumer;
import fr.birdia.tile19.endpoint.event.consumer.model.ConsumableEvent;
import fr.birdia.tile19.endpoint.event.consumer.model.ConsumableEventTyper;
