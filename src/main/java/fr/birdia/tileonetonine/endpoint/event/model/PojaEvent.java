package fr.birdia.tileonetonine.endpoint.event.model;

import static fr.birdia.tileonetonine.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import fr.birdia.tileonetonine.PojaGenerated;
import fr.birdia.tileonetonine.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "fr.birdia.tileonetonine.event1";
    return "fr.birdia.tileonetonine.event2";
  }
}
