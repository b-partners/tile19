package fr.birdia.tileonetonine.handler;

import static fr.birdia.tileonetonine.concurrency.ThreadRenamer.renameWorkerThread;
...
import fr.birdia.tileonetonine.PojaApplication;
import fr.birdia.tileonetonine.PojaGenerated;
import fr.birdia.tileonetonine.endpoint.EndpointConf;
import fr.birdia.tileonetonine.endpoint.event.EventConf;
import fr.birdia.tileonetonine.endpoint.event.consumer.EventConsumer;
import fr.birdia.tileonetonine.endpoint.event.consumer.model.ConsumableEvent;
import fr.birdia.tileonetonine.endpoint.event.consumer.model.ConsumableEventTyper;
