...
import fr.birdia.tile19.endpoint.event.consumer.model.TypedEvent;
import fr.birdia.tile19.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("fr.birdia.tile19.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("fr.birdia.tile19.endpoint.event.model.UuidCreated", payload);
