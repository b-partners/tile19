...
import fr.birdia.tileonetonine.endpoint.event.consumer.model.TypedEvent;
import fr.birdia.tileonetonine.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new TypedEvent("fr.birdia.tileonetonine.endpoint.event.model.UuidCreated", payload);
